...
def get_args_parser():
    ...
    parser.add_argument('--label_label_root', default='supervised_annotations/aerial/aligned_ids/',
                        help='percent with fully labeled')
    parser.add_argument('--unlabel_label_root', default='unsupervised_annotations',
                        help='percent with fully labeled')
...
def main(args):
    ...
    # Init SAM
    if args.sam:
        sam = SAM(args.device, data_path=args.data_path) # init
        sam.setup() # setup 
    else:
        sam = None
        ...
        if epoch < args.BURN_IN_STEP:
            ...
            if args.output_dir:
                ...
                for checkpoint_path in checkpoint_paths:
                    ...
                    # Add 'thrs' and 'scores' only if args.gmm is True
                    if args.gmm:
                        checkpoint_data['thrs'] = thrs
