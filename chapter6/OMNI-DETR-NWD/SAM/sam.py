...
class SAM():
    ...
    def __init__(self, device, data_path=None) -> None:
        ...
        self.data_path = '../../SDU-GAMODv3/unsupervised_annotations/aerial/' # used to prepend all image files names during training
    ...
    def replaces_bboxes_with_sam_bboxes(self, image, boxes, satisfied_class, save_plt=False):
        # print("BOXES")
        # print(boxes)
        # print("CLASSES")
        ...
        cost_assigning_bbox = gaussian_loss_matcher_v2(boxes, new_boxes)
