...
from dataset.torchvision_datasets.coco import CocoDetection as TvCocoDetection
from utils import get_local_rank, get_local_size
import dataset.transforms as T
import torchvision.transforms as transforms


class CocoDetection(TvCocoDetection):
    def __init__(self, img_folder, ann_file, image_set, transforms, return_masks=False, cache_mode=False, local_rank=0, local_size=1):
...
def make_coco_transforms(image_set):
    ...
    if image_set == 'val' or image_set == 'test':
        return T.Compose([
            ...
            normalize, # not sure we should normalize 
        ])
...
def build(image_set, args):
    ...
    # GAAMOD
    elif args["dataset_file"] == "gamod" or args["dataset_file"] == "dvd":
        PATHS = {
