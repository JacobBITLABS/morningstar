"""
This file is the original coco.py
"""
# ------------------------------------------------------------------------
# Deformable DETR
...
from .torchvision_datasets import VanillaCocoDetection as TvVanillaCocoDetection
from util.misc import get_local_rank, get_local_size
import datasets.transforms as T
from util.ga import View

class CocoDetection(TvVanillaCocoDetection):
...
def build(image_set, args, view: View):
    ...
    elif args.dataset_file == "dvd" and view == View.GROUND:
        PATHS = {
            # ground
            "train": (root / 'scaled_dataset' / 'train' / 'groundview', root / 'supervised_annotations' / 'ground' / 'aligned_ids' / 'ground_train_aligned_ids_w_indicator_with_perspective_with_points.json'),
            "val": (root / 'scaled_dataset' / 'val' / 'groundview', root / 'supervised_annotations' / 'ground' / 'aligned_ids' / 'ground_valid_aligned_ids_w_indicator.json'),
            "test": (root / 'scaled_dataset' / 'val' / 'groundview', root / 'supervised_annotations' / 'ground' / 'aligned_ids' / 'ground_valid_aligned_ids_w_indicator.json'),
        }   
    elif args.dataset_file == "dvd" and view == View.AERIAL:
         PATHS = {
            # aerial
            ...
            "test": (root / 'scaled_dataset' / 'val' / 'droneview', root / 'supervised_annotations' / 'aerial' / 'aligned_ids' / 'aerial_valid_aligned_ids_w_indicator.json'),
