...
def main(args):
    ...
    RESUME_PATH = '../Deformable-DETR-Finetune/results/gamod/ground/checkpoint0039.pth'
    ...
    t0 = time.time()
    DATA_DIR = '../../DATASET/SDU-GAMODv4-old/scaled_dataset/val/groundview/'
    ...
    #read file
    dataDir='../../DATASET/SDU-GAMODv4-old/supervised_annotations/ground/aligned_ids/'
    dataType = 'ground_valid_aligned_ids_w_indicator' #cocoFIle
    ...
    for IMG in IMG_NAME_LIST:
        ...
        topk_values, topk_indexes = torch.topk(prob.view(out_logits.shape[0], -1), 40, dim=1)
        scores = topk_values
