...
def build(image_set, args):
    ...
    # visDrone MOT
        ...
        PATHS = {
            "train": (root / "scaled_label_train", root / "annotations" / args.annotation_json_label),
            "val": (root / "scaled_label_val", root / "annotations" / 'scaled_annotations_visdrone_val_w_indicator.json'),
            #"test": (root / "scaled_label_test", root / "annotations" / 'scaled_label_test.json'),
        }
    # SDUGAMOD
    elif args.dataset_file == "dvd":
        PATHS = {
            "train": (root / 'scaled_dataset' / 'train' / 'droneview', root / 'supervised_annotations' / 'aerial'  / 'aligned_ids' / args.annotation_json_label),
    ...
    elif args.dataset_file == "sdugamod_ground":
        PATHS = {
            "train": (root / "scaled_dataset/all_ground_images", root / "supervised_annotations/ground/aligned_ids" / args.annotation_json_label),
            "val": (root / "scaled_dataset/all_ground_images/", root / "supervised_annotations/ground/aligned_ids" / "ground_valid_aligned_ids_w_indicator.json"),
        }
    else:
        PATHS = {
...
def build_semi_unlabel(image_set, args):
    ...
    # visDrone
        ...
        PATHS = {
            # "train": (root / "scaled_unlabel_train", root / "annotations" / args.annotation_json_unlabel),
            # "val": (root / "scaled_label_val", root / "annotations" / 'scaled_visDrone_label_val_w_indicator.json'),

            "train": (root / "scaled_label_train", root / "annotations" / args.annotation_json_unlabel),
            "train": (root / "scaled_dataset/all_ground_images", root / "supervised_annotations/aerial/aligned_ids" / args.annotation_json_unlabel),
            "val": (root / "scaled_dataset/all_ground_images/", root / "supervised_annotations/ground/aligned_ids" / "ground_valid_aligned_ids_w_indicator.json"),
        }
    # SDUGAMOD
    elif args.dataset_file == "dvd":
        root_unlabel = "../../SDU-GAMODv3/"
        PATHS = {
            # "train": (root_unlabel / "unsupervised_annotations" / "aerial", root_unlabel / "unsupervised_annotations" / args.annotation_json_unlabel),
            "train": ("../../SDU-GAMODv3/unsupervised_annotations/aerial/",  "../../SDU-GAMODv3/unsupervised_annotations/Aerial_8605_scaled_labels_w_indicator_aligned_ids.json"), # / args.annotation_json_unlabel),
            "val": (root / 'scaled_dataset' / 'val' / 'droneview', root / 'supervised_annotations' / 'aerial' / 'aligned_ids' / 'aerial_valid_aligned_ids_w_indicator.json'),
        }
    elif args.dataset_file == "sdugamod_ground":
        PATHS = {
            "train": (root / "../SDU-GAMODv1/unlabeled_dataset/groundview/data", root / "unsupervised_annotations" / args.annotation_json_unlabel),
            "val": (root / "scaled_dataset/all_ground_images/", root / "supervised_annotations/ground/aligned_ids" / "ground_valid_aligned_ids_w_indicator.json"),
        }
    else:
        PATHS = {
