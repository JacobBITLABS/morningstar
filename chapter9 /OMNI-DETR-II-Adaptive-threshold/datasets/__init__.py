...
def build_dataset(image_set, label, args):
    ...
    if args.dataset_file == 'crowdhuman_omni' and image_set == 'burnin' and label == True:
        return build_coco('train', args)
    # visDrone added
    if args.dataset_file == 'visDrone' and image_set == 'train' and label == True:
        return build_coco_semi_label(image_set, args)
    if args.dataset_file == 'visDrone' and image_set == 'train' and label == False:
        return build_coco_semi_unlabel(image_set, args)
    if args.dataset_file == 'visDrone' and image_set == 'val' and label == True:
        return build_coco(image_set, args)
    if args.dataset_file == 'visDrone' and image_set == 'burnin' and label == True:
        return build_coco('train', args)
    # SDU GAMOD args.dataset_file == "sdugamod_aerial" or 
    ...
    if args.dataset_file == 'dvd' and image_set == 'burnin' and label == True:
        return build_coco('train', args)
    # GAMOD
    if args.dataset_file == 'sdugamod_ground' and image_set == 'train' and label == True:
        return build_coco_semi_label(image_set, args)
    if args.dataset_file == 'sdugamod_ground' and image_set == 'train' and label == False:
        return build_coco_semi_unlabel(image_set, args)
    if args.dataset_file == 'sdugamod_ground' and image_set == 'val' and label == True:
        return build_coco(image_set, args)
    if args.dataset_file == 'sdugamod_ground' and image_set == 'burnin' and label == True:
        return build_coco('train', args)
